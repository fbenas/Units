...
public class Ground extends Nothing
{
    ...
    public Ground(int xValue, int yValue, String nameValue, Config configValue)
    {
        super(nameValue, GridType.GROUND, 3, configValue);
    ...
    public void clearSpace(int xValue, int yValue)
    {
        ...
        {
            ground[xValue][yValue] = new Nothing(config);
